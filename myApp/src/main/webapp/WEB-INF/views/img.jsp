...
<head>
	...
	<link rel="stylesheet" href="resources/css/vendor/jquery.Jcrop.css">
	<link rel="stylesheet" href="resources/css/demo.css">
	
<script src="resources/js/load-image.js"></script>
<script src="resources/js/load-image-scale.js"></script>
<script src="resources/js/load-image-meta.js"></script>
<script src="resources/js/load-image-fetch.js"></script>
<script src="resources/js/load-image-exif.js"></script>
<script src="resources/js/load-image-exif-map.js"></script>
<script src="resources/js/load-image-orientation.js"></script>
<!-- jQuery and Jcrop are not required by JavaScript Load Image, but included for the demo -->
<script src="resources/js/vendor/jquery.js"></script>
<script src="resources/js/vendor/jquery.Jcrop.js"></script>
<script src="resources/js/demo/demo.js"></script>
